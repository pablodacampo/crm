...
<html lang="en">
  <head>
    ...
    <title>USN France | Edit Finances</title>
  ...
  <header id="header">
    ...
    Admin Area <small>| Edit Finances</small></h1>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 offset-md-2">
          <form class="text-center" id="edit_finances" action="config/functions.php" method="POST">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                <label>Sales Rep</label>
                  <input type="text" class="form-control text-center bg-dark text-primary" name="" id="" value="<?php ?>">
              </div> <!-- form-group end.// -->
            </div> <!-- form-row end.// --> 
            ...
            <a href="finances.php"><button type="button" class="btn btn-outline-danger col-2">Cancel</button></a>

            <button type="submit" name="editFinances" class="btn btn-outline-success col-2">Save</button> 
          </div>
        </form>
        </div>
      </div>
